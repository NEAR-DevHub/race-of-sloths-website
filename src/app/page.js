...
const Buttons = () => (
  <div className="flex flex-col md:flex-row justify-center md:justify-start gap-8">
    ...
    <Link href="https://github.com/race-of-sloths/race-of-sloths-onboarding" target="_blank" className="m-auto md:m-0 w-fit text-[#242424] bg-white rounded-full font-semibold text-lg px-6 py-3">
      Try it out
    </Link>
  </div>
);
